...
// main. This repo is SEPARATE from the web app (Volksswitch/bliss-tactile-symbols-web)
// so the .scad can be released independently; the app fetches this manifest and the
// .scad from here via raw.githubusercontent.com.
...
// This repo hosts the canonical .scad. Must match SCAD_REPO in the web app's
// app.html — the raw download URL the update mechanism fetches (spaces encoded).
const SCAD_REPO = 'Volksswitch/bliss-tactile-symbols';
const scadUrl = `https://raw.githubusercontent.com/${SCAD_REPO}/main/${encodeURIComponent(SCAD_NAME)}`;
